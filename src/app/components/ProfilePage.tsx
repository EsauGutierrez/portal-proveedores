...
import { Loader2, AlertCircle, Upload, CheckCircle, XCircle, Clock, Check, X, Lock } from 'lucide-react';
...
const ChangePasswordModal = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-gray-900/50 backdrop-blur-sm flex justify-center items-center z-50 p-4">
      <div className="bg-white rounded-xl shadow-xl w-full max-w-md overflow-hidden">
        <div className="p-6 bg-blue-50 border-b flex flex-col items-center text-center">
        ...
        {success ? (
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-4">
            ...
            <PasswordRequirementChecklist
              ...
              extra={[
                { label: 'Diferente a la contraseña actual', met: form.currentPassword.length > 0 && form.newPassword.length > 0 && form.newPassword !== form.currentPassword },
                { label: 'Las contraseñas coinciden', met: form.newPassword.length > 0 && form.newPassword === form.confirmPassword },
              ]}
            />
            <div className="pt-2 flex justify-end space-x-3">
              ...
              <button
                ...
                className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 font-medium text-sm disabled:opacity-50 flex items-center"
              >
      ...
      <div className="mt-8 border-t pt-6">
        ...
        <div className="mt-8 flex flex-wrap gap-4">
          ...
          <button
            ...
            className="w-full md:w-auto flex items-center justify-center bg-white border border-gray-300 hover:bg-gray-50 text-gray-700 font-bold py-2 px-4 rounded-lg transition duration-300"
          >
