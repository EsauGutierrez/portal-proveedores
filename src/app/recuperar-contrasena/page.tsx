...
function ResetPasswordForm() {
    ...
    useEffect(() => {
        if (!token) {
            setError('El enlace no es válido. Por favor, solicita uno nuevo desde el portal.');
        }
    }, [token]);
            ...
            <div className="w-full max-w-md bg-white rounded-xl shadow-lg p-8">
                ...
                {success ? (
                    <div className="text-center">
                        ...
                        <p className="text-gray-500 mb-6">Tu contraseña ha sido actualizada. Ya puedes iniciar sesión.</p>
                        <a
                            href="/"
